...
export default class Avatar extends Component {
  defaultImage() {
    ...
    const path = `/embed/avatars/${avatar}.png?size=256`;
  ...
  customImage() {
    ...
    return (
      <>
        <source srcSet={BASE_URL + path + ".webp?size=256"} type="image/webp" />
        <img className="icon" src={BASE_URL + path + ".png?size=256"} alt="avatar" />
      </>
    );
  }
